# Bazzite-DX: Agentic Excellence (ai)
# A ready-to-code local AI ecosystem.

# --- Taps (Trusted Sources) ---
tap "ublue-os/tap"                                  # For Goose
...
brew "anomalyco/tap/opencode-v2"                    # Open source AI coding assistant
