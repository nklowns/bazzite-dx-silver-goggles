...
brew "nushell"              # Nushell: A modern, structured shell for 2026
brew "jj"                   # Jujutsu: Version control for concurrent AI agents (2026)
brew "gitoxide"             # Pure Rust Git implementation for high-speed VCS
cask "gitbutler"            # AST-aware Git orchestration (2026)
...
brew "kernel/tap/hypeman"   # VM: Docker-style micro-VM manager (2026)
