...
readonly AUDIT_REGISTRY=(
	...
	"file|/usr/lib/systemd/user/nomad-recoll-index.service|Asset: Recoll Indexer Service|Error"
	"file|/usr/lib/systemd/user/nomad-recoll-index.timer|Asset: Recoll Nightly Indexer Timer|Error"
