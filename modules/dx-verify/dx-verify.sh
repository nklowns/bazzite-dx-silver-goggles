...
readonly AUDIT_REGISTRY=(
	...
	"file|/etc/skel/.config/krunnerrc|Asset: KRunner Default Favorites Config|Error"
	...
	"file|/usr/bin/krunner-dx-workspaces|Asset: KRunner DX Workspaces Runner Script|Error"
	"file|/usr/share/krunner/dbusplugins/plasma-runner-dx-workspaces.desktop|Asset: KRunner DX Workspaces Desktop Entry|Error"
	"file|/usr/share/dbus-1/services/org.kde.bazzite.dx.workspaces.service|Asset: KRunner DX Workspaces DBus Service|Error"
	"file|/usr/lib/systemd/user/krunner-dx-workspaces.service|Asset: KRunner DX Workspaces User Unit|Error"
	"file|/usr/share/icons/hicolor/scalable/apps/krunner-dx-workspaces.svg|Asset: KRunner DX Workspaces Icon|Error"
	"file|/usr/share/icons/hicolor/512x512/apps/code.png|Asset: VSCode System Icon|Error"
	...
	"file|/etc/containers/systemd/users/mesh-searxng.container|Asset: SearXNG Quadlet|Error"
	"file|/etc/containers/systemd/users/mesh-vane.container|Asset: Vane AI Search Quadlet|Error"
	"file|/etc/containers/systemd/users/mesh-tor.container|Asset: Tor SOCKS5 Quadlet|Error"
	"file|/etc/containers/systemd/users/mesh-trawl.container|Asset: Trawl Anti-Captcha Quadlet|Error"
	"file|/etc/containers/systemd/users/mesh-i2pd.container|Asset: I2P Daemon Quadlet|Error"
	"file|/etc/containers/systemd/users/mesh-recoll.container|Asset: Recoll Local Workspace Quadlet|Error"
	"file|/usr/lib/systemd/user/mesh-recoll-index.service|Asset: Recoll Indexer Service|Error"
	"file|/usr/lib/systemd/user/mesh-recoll-index.timer|Asset: Recoll Nightly Indexer Timer|Error"
	"file|/usr/share/recoll/recoll.conf.template|Asset: Recoll Configuration Template|Error"
	"file|/etc/containers/systemd/users/lightpanda.container|Asset: Lightpanda CDP Quadlet|Error"
	"file|/usr/share/searxng/settings.template.yml|Asset: SearXNG Settings Template|Error"
	"file|/etc/containers/systemd/users/aistudio-visual.container|Asset: AI Studio Visual Quadlet (ComfyUI)|Error"
	"file|/etc/containers/systemd/users/aistudio-audio.container|Asset: AI Studio Audio Quadlet (Speaches)|Error"
	"file|/etc/containers/systemd/users/mediamtx.container|Asset: MediaMTX Quadlet|Error"
	"file|/etc/containers/systemd/users/rustdesk-hbbr.container|Asset: RustDesk Relay Quadlet|Error"
	"file|/etc/containers/systemd/users/rustdesk-hbbs.container|Asset: RustDesk Server Quadlet|Error"
	...
	"file|/usr/lib/tmpfiles.d/ai-search.conf|Policy: AI Search Storage Structure|Error"
	...
	"file|/usr/bin/ollama|Asset: Ollama Host Wrapper|Error"
